...
class RequestWizard(models.TransientModel):
    ...
    activity_type_id = fields.Many2one('mail.activity.type',
                                       ...
                                       default=lambda self: self.env.ref('document.mail_document_activity_data_md',
    ...
    def request_document(self):
        ...
        if request_by_mail:
            ...
            share = self.env['document.share'].create(share_vals)
            share.send_share_by_mail('document.mail_template_document_request')
