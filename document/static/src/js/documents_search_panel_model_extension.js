odoo.define("document/static/src/js/document_search_panel_model_extension", function (require) {
    "use strict";
    ...
    class documentSearchPanelModelExtension extends SearchPanelModelExtension {
        ...
        /**
         * Returns a description of each folder (record of document.folder).
         * @returns {Object[]}
         */
        getFolders() {
        ...
        /**
         * Returns a description of each tag (record of document.tag).
         * @returns {Object[]}
         */
        getTags() {
            const { values } = this.getSections(isTagFilter)[0];
    ...
    ActionModel.registry.add("documentSearchPanel", documentSearchPanelModelExtension, 30);

    return documentSearchPanelModelExtension;
});
