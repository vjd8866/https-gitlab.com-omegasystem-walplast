odoo.define('document.viewMixin', function (require) {
'use strict';

const documentViewMixin = {
    inspectorFields: [
        'active',
        'activity_ids',
        'available_rule_ids',
    ...
    init(viewInfo, { controllerState: { selectedRecordIds, }={}, }={}) {
        ...
        // force the presence of a searchpanel in document
        ...
        // add the fields used in the documentInspector to the list of fields to fetch
        ...
        // rules to display in the documentInspector
