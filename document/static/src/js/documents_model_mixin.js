odoo.define('document.modelMixin', function (require) {
'use strict';

const documentModelMixin = {
     ...
     * documentSelector is used for the classical search_read.
     *
     ...
     * documentInspector, and to explicitely specify the 'searchDomain', which
    ...
    /**
     * Fetch additional data required by the documentList view.
     *
     * @private
    ...
    /**
     * Fetch the sum of the size of the document matching the current domain.
     *
     * @private
     * @param {Object} [param0]
     * @param {Array} domain
