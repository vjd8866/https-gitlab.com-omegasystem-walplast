odoo.define('document.component.PdfPage', function (require) {
'use strict';
...
class PdfPage extends owl.Component {
    ...
    _onDragStart(ev) {
        ...
        ev.dataTransfer.setData('o_document_pdf_data', this.props.pageId);
    }
    /**
     * @private
     * @param {MouseEvent} ev
    ...
    _onDrop(ev) {
        this.state.isHover = false;
        if (!ev.dataTransfer.types.includes('o_document_pdf_data')) {
            return;
        }
        const pageId = ev.dataTransfer.getData('o_document_pdf_data');
...
PdfPage.template = 'document.component.PdfPage';
