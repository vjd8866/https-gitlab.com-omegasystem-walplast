...
class WpLeadController(http.Controller):
    ...
    @http.route('/wmvdapi/create_lead', methods=["POST"], type='json', auth='public')
    ...
    @http.route('/wmvdapi/get_user_leads', auth='public', methods=["POST"], type='json')
    ...
    # @http.route('/wmvdapi/get_state_wise_leads', auth='user', methods=["POST"], type='json')
    @http.route('/wmvdapi/get_state_wise_leads', auth='public', methods=["POST"], type='json')
    def get_state_wise_leads(self, user_id=None,search_kw=None):
        print("------------/wmvdapi/get_state_wise_leads -----------")
        ...
        if search_kw:
            lead_rec = request.env['crm.lead'].sudo().search(['|',('user_id.state_id', 'in', emp.allowed_state_ids.ids),('user_id.state_id', '=', emp.user_id.state_id.id),('name','ilike',search_kw)])
        else:
            lead_rec = request.env['crm.lead'].sudo().search(['|',('user_id.state_id', 'in', emp.allowed_state_ids.ids),('user_id.state_id', '=', emp.user_id.state_id.id)])
    ...
    @http.route('/wmvdapi/get_partner_group', auth='public', methods=["POST"], type='json')
    def get_partner_group(self):
        print("------------/wmvdapi/get_partner_group -----------")
        result = request.env['res.partner.group'].sudo().search([('company_id','=', company_id)]).read(mainfields)
    ...
    @http.route('/wmvdapi/get_country_state', auth='public', methods=["POST"], type='json')
    def get_country_state(self):
        print("------------/wmvdapi/get_country_state -----------")
        result = request.env['res.country.state'].sudo().search([]).read(mainfields)
        state = {'success': result or {}, 'error': None}
        return state

    # @http.route('/wmvdapi/get_country', auth='user', methods=["POST"], type='json')
    @http.route('/wmvdapi/get_country', auth='public', methods=["POST"], type='json')
    def get_country(self):
        print("------------/wmvdapi/get_country -----------")
        result = request.env['res.country'].sudo().search([]).read(mainfields)
        country = {'success': result or {}, 'error': None}
        return country


    # @http.route('/wmvdapi/edit_lead', methods=["POST"], type='json', auth='user')
    @http.route('/wmvdapi/edit_lead', methods=["POST"], type='json', auth='public')
    def edit_lead(self, lead_id=None, user_id=None, vals=None):
        ...
        if vals:
            ...
            if lead:
                for res in vals:
                    if 'mobile' in res:
                        mobilelead = request.env['crm.lead'].sudo().search([('mobile_lead_id', '=', lead_id),
                                                                            ('mobile', '!=', res['mobile'])])
                        if mobilelead:
    ...
    @http.route('/wmvdapi/lead_to_retailer', auth='public', methods=["POST"], type='json')
